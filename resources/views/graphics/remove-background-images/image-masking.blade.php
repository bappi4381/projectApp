@extends('layouts.app')
@section('title', 'Professional Image Masking Service | Graphics Studio')
@section('meta_description', 'High-quality hair and fur image masking services. Expert Photoshop techniques for complex, translucent, and soft-edged product cutouts.')
...
@section('content')
    <div class="bg-white min-h-screen text-slate-800 font-sans selection:bg-[#0ea5e9] selection:text-white pb-20">
        ...
        @include('graphics.partials.service-hero', [
            ...
            'description' => 'Advanced Photoshop masking for complex images. Perfect for hair, fur, transparent objects, and soft edges.',
            'hero_image' => 'https://images.unsplash.com/photo-1582233113702-86927d3fa87a?auto=format&fit=crop&w=1200&q=80',
        ...
        <div class="container mx-auto px-6 max-w-6xl py-20 text-center">
            ...
            <p class="text-slate-500 text-sm leading-relaxed max-w-3xl mx-auto mb-10">
                To offer top-notch masking, we have classified our image masking service into 4 categories based on edge complexity. From simple translucent objects to complex furry subjects, we use advanced Photoshop techniques to ensure perfect cutouts.
            </p>
        ...
        <div class="container mx-auto px-6 max-w-6xl mb-20">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                @php
                    $categories = [
                        [
                            'name' => 'Hair & Fur Masking',
                            'price' => '0.99',
                            'desc' => 'Perfect for models with flying hair or animal fur. We use background eraser and refine edge tools to ensure every single hair strand is perfectly separated from the background naturally.',
                            'img1' => 'https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&w=800&q=80',
                            'img2' => 'https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&w=800&q=80&sat=-100',
                        ],
                        [
                            'name' => 'Transparent Object Masking',
                            'price' => '1.49',
                            'desc' => 'Glasses, bottles, water, and plastic objects require special alpha channel masking. We manage gradients, opacities, and reflections to retain realism while replacing the background.',
                            'img1' => 'https://images.unsplash.com/photo-1575231920803-cfa090b8fbbb?auto=format&fit=crop&w=800&q=80',
                            'img2' => 'https://images.unsplash.com/photo-1575231920803-cfa090b8fbbb?auto=format&fit=crop&w=800&q=80&sepia=100',
                        ],
                        [
                            'name' => 'Translucent Masking',
                            'price' => '1.99',
                            'desc' => 'Used for fabrics like smoke, chiffon, lace, or muslin. We extract the subject while maintaining the fabric\'s semi-transparent qualities, allowing any new background to show through perfectly.',
                            'img1' => 'https://images.unsplash.com/photo-1582233113702-86927d3fa87a?auto=format&fit=crop&w=800&q=80',
                            'img2' => 'https://images.unsplash.com/photo-1582233113702-86927d3fa87a?auto=format&fit=crop&w=800&q=80&sepia=100',
                        ],
                        [
                            'name' => 'Complex Alpha Channel Masking',
                            'price' => '3.49',
                            'desc' => 'Applied on images with both sharp and totally soft edges, requiring a combination of deep-etching, channel masking, and color range selection to achieve a flawless multi-layered cutout.',
                            'img1' => 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=800&q=80',
                            'img2' => 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=800&q=80&sepia=100',
                        ],
                    ];
                @endphp
            ...
            <div class="container mx-auto px-6 max-w-6xl text-center">
                ...
                <div class="bg-slate-50/50 py-24 border-t border-slate-100">
                    <div class="container mx-auto px-6 max-w-6xl text-center">
                        <h2 class="text-[28px] md:text-[34px] font-black text-slate-900 mb-6 uppercase tracking-tight">
                            IMAGE MASKING COMPLEXITIES AND PRICES
                        </h2>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-16 mb-20">
                            @php
                                $complexities = [
                                    ['name' => 'Hair Masking', 'price' => '0.99', 'img' => 'https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&w=600&q=80'],
                                    ['name' => 'Fur Masking', 'price' => '1.49', 'img' => 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=600&q=80'],
                                    ['name' => 'Transparent Object', 'price' => '1.99', 'img' => 'https://images.unsplash.com/photo-1575231920803-cfa090b8fbbb?auto=format&fit=crop&w=600&q=80'],
                                    ['name' => 'Translucent Fabric', 'price' => '2.49', 'img' => 'https://images.unsplash.com/photo-1582233113702-86927d3fa87a?auto=format&fit=crop&w=600&q=80'],
                                    ['name' => 'Refine Edge Masking', 'price' => '3.49', 'img' => 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=600&q=80'],
                                    ['name' => 'Complex Alpha Channel', 'price' => '4.99', 'img' => 'https://images.unsplash.com/photo-1596484552834-6a58f850e0a1?auto=format&fit=crop&w=600&q=80'],
                                ];
                            @endphp
                ...
                <div class="bg-white py-24 border-t border-slate-100">
                        ...
                        <div class="text-center mb-20">
                            <h2 class="text-[28px] md:text-[34px] font-black text-slate-900 mb-6 uppercase tracking-tight">
                                How to Apply Image Masking Techniques
                            </h2>
                            <div class="flex justify-center gap-2">
                                <div class="w-1.5 h-1.5 bg-emerald-500 rounded-full"></div>
                                <div class="w-1.5 h-1.5 bg-yellow-400 rounded-full"></div>
                            ...
                            <p class="text-slate-500 text-sm leading-relaxed max-w-4xl mx-auto mt-8">
                                Removing backgrounds from furry, hairy, or transparent objects requires a completely different approach than a standard clipping path. Here is how our experts utilize masking for perfect results:
                            </p>
                        </div>

                        {{-- Method 1: Alpha Channel --}}
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
                            <div class="space-y-6">
                                <h3 class="text-xl font-black text-slate-800 uppercase tracking-tight">Alpha Channel Masking</h3>
                                <div class="text-slate-600 text-[13px] leading-relaxed space-y-6 text-justify">
                                    <p>When dealing with hair, fur, or complex semi-transparent materials, we use Alpha Channel masking to separate the subjects based on visual contrast. By adjusting the RGB channels, we can pinpoint intricate details.</p>
                                    <p>This allows us to strip away the background without leaving behind jagged edges or completely deleting wisps of hair, ensuring the subject looks natural against any new background.</p>
                                </div>
                            </div>
                            <div class="aspect-[4/3] rounded-xl overflow-hidden shadow-2xl border border-slate-100 bg-slate-50">
                                <img src="https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&w=800&q=80" alt="Alpha Channel Masking Logic" class="w-full h-full object-cover">
                            </div>
                        </div>

                        {{-- Method 2: Transparent Object --}}
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                            <div class="order-2 lg:order-1 aspect-[4/3] rounded-xl overflow-hidden shadow-2xl border border-slate-100 bg-slate-50">
                                <img src="https://images.unsplash.com/photo-1575231920803-cfa090b8fbbb?auto=format&fit=crop&w=800&q=80" alt="Transparent Object Logic" class="w-full h-full object-cover">
                            </div>
                            <div class="order-1 lg:order-2 space-y-6">
                                <h3 class="text-xl font-black text-slate-800 uppercase tracking-tight">Extracting Translucent Objects</h3>
                                <div class="text-slate-600 text-[13px] leading-relaxed space-y-6 text-justify">
                                    <p>Items like glasses, glass bottles, and smoke present a unique challenge because the background shines straight through them. <span class="text-[#0ea5e9] font-bold">Transparent masking</span> is required here.</p>
                                    <p>We delicately isolate the reflections, glare, and shadows from the glass material while deleting the unwanted backdrop. This guarantees that when you place the object on a different background, the new color realistically transmits through the glass.</p>
                                </div>
                            </div>
                        </div>

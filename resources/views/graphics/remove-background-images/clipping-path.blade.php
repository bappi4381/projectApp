            ...
            <div class="container mx-auto px-6 max-w-6xl">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                    <div>
                        ...
                        <div class="text-2xl font-black text-white">49<span class="text-sm">¢</span></div>
                ...
                @php
                    $categories = [
                        [
                            ...
                            'price' => '0.49',
                            'desc' => 'Basic clipping path is mainly applied on products appearing straight, rectangular, square, round, and oval. It’s an elementary category in which products don’t contain any hole. Among the products that come under this category: book, cup, monitor, mobile, ball, egg, etc. are worth mentioning.',
                            'img1' => 'https://images.unsplash.com/photo-1570913149827-d2ac84ab3f9a?auto=format&fit=crop&w=800&q=80',
                            'img2' => 'https://images.unsplash.com/photo-1570913149827-d2ac84ab3f9a?auto=format&fit=crop&w=800&q=80&sat=-100',
                        ],
                        [
                            'name' => 'Simple Clipping Path',
                            'price' => '0.99',
                            'desc' => 'Simple clipping path is utilized on straight, square, rectangular, round, and oval products. But the core difference between simple and basic clipping path is in the existence of hole. In simple clipping path, products like Shirt, pants, watch, glass, ring  show up with holes.',
                            'img1' => 'https://images.unsplash.com/photo-1544203072-4130021df662?auto=format&fit=crop&w=800&q=80',
                            'img2' => 'https://images.unsplash.com/photo-1544203072-4130021df662?auto=format&fit=crop&w=800&q=80&sepia=100',
                        ],
                        [
                            'name' => 'Medium Clipping Path',
                            'price' => '1.50',
                            'desc' => 'In medium clipping path, products contain several holes, unlike simple clipping path. The products also show up with a higher number of anchor points, meaning the curves and twists are more. Products like: bracelet, shoe, knick-knack, engine parts, set of watches, etc. come under this category.',
                            'img1' => 'https://images.unsplash.com/photo-1556306535-0f09a537f0a3?auto=format&fit=crop&w=800&q=80',
                            'img2' => 'https://images.unsplash.com/photo-1556306535-0f09a537f0a3?auto=format&fit=crop&w=800&q=80&sepia=100',
                        ],
                        [
                            'name' => 'Complex Clipping Path',
                            'price' => '4.50',
                            'desc' => 'Complex clipping path as the name appears is used for products having complex shapes and designs. Generally, products having many holes (Over 10) and many closed paths fall under this category. Products under this method include necklace, chain, net, furry doll, chandelier, tree, building, etc.',
                            'img1' => 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?auto=format&fit=crop&w=800&q=80',
                            'img2' => 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?auto=format&fit=crop&w=800&q=80&sepia=100',
                        ],
                    ];
                @endphp
                ...
                <div class="bg-slate-50/50 py-24 border-t border-slate-100">
                    <div class="container mx-auto px-6 max-w-6xl text-center">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-16 mb-20">
                            @php
                                $complexities = [
                                    ['name' => 'Basic Clipping Path', 'price' => '0.49', 'img' => 'https://images.unsplash.com/photo-1590247813693-5541d1c609fd?auto=format&fit=crop&w=600&q=80'], // CD/DVD
                                    ['name' => 'Simple Clipping Path', 'price' => '0.99', 'img' => 'https://images.unsplash.com/photo-1547996160-81dfa63595aa?auto=format&fit=crop&w=600&q=80'], // Watch
                                    ['name' => 'Compound Clipping Path', 'price' => '2.99', 'img' => 'https://images.unsplash.com/photo-1540932239986-30128078f3c5?auto=format&fit=crop&w=600&q=80'], // Coral/Decorative
                                    ['name' => 'Extra-compound Clipping Path', 'price' => '4.49', 'img' => 'https://images.unsplash.com/photo-1540497077202-7c8a3999166f?auto=format&fit=crop&w=600&q=80'], // Gym Gear
                                    ['name' => 'Complex Clipping Path', 'price' => '7.49', 'img' => 'https://images.unsplash.com/photo-1558981403-c5f91cbba527?auto=format&fit=crop&w=600&q=80'], // Motorcycle
                                    ['name' => 'Extra-complex Clipping Path', 'price' => '9.99', 'img' => 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?auto=format&fit=crop&w=600&q=80'], // Bicycle
                                ];
                            @endphp
                ...
                <div class="bg-white py-24 border-t border-slate-100">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
                            <div class="space-y-6">
                                ...
                                <div class="text-slate-600 text-[13px] leading-relaxed space-y-6 text-justify">
                                    ...
                                    <p>At first, our professional photo editors draw a path around the edge of a subject. Once the path drawing is complete, the image background is removed and the subject remains as part of the image.</p>
                                    <p>Clipping path is generally applied to the photographs that contain objects having hard and smooth edges like table, chair, mannequin, etc. For the sake of providing better output, we categorize this into different parts based on product difficulty.</p>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                            <div class="order-2 lg:order-1 aspect-[4/3] rounded-xl overflow-hidden shadow-2xl border border-slate-100 bg-slate-50">
                                <img src="https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&w=800&q=80" alt="2 Pixel Edge Logic" class="w-full h-full object-cover">
                            </div>
                            <div class="order-1 lg:order-2 space-y-6">
                                <h3 class="text-xl font-black text-slate-800 uppercase tracking-tight">Apply Path Around 2 Pixels Inside from Product Edge</h3>
                                <div class="text-slate-600 text-[13px] leading-relaxed space-y-6 text-justify">
                                    <p>When clipping path technique isn't adequate to maintain perfection in background cutout, <span class="text-[#0ea5e9] font-bold">image masking</span> is the go-to one then. Image masking is a strategy we apply in objects having soft and rough edges using pen tablet (Wacom) that enables hand-drawing and selecting images with accuracy. The remaining portions having a hard edge are drawn and selected by the pen tool of Adobe Photoshop.</p>
                                    <p>Depending on the needs of an image, we apply different sorts of image masking techniques, including layer masking, alpha channel masking, fur and hair masking, transparent masking, refine edge masking, and color masking to cut out the background.</p>
                                </div>
                            </div>
                        </div>

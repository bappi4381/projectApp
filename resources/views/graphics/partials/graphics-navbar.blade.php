        ...
        <div class="flex items-center justify-between h-20 md:h-24 transition-all duration-500" id="studio-nav-inner">
            ...
            <div class="hidden xl:flex items-center gap-10">
                ...
                @else
                    ...
                    <div x-data="{ imageEditOpen: false }" @mouseenter="imageEditOpen = true"
                        @mouseleave="imageEditOpen = false" class="relative group">
                        <a href="{{ route('graphics.services') }}"
                            ...
                            <i class="ri-arrow-down-s-line text-[14px] transition-transform duration-300"
                                :class="imageEditOpen ? 'rotate-180' : ''"></i>
                            <span class="studio-link-dot"
                                :class="activeSection === 'services' || request()->is('services*') ? 'active-dot' : ''"></span>
                        </a>

                        <div x-show="imageEditOpen" x-cloak class="fixed left-0 right-0 pt-6 z-[60]" style="top: auto;"
                            ...
                            <div
                                class="bg-white rounded shadow-xl border border-[#eee] py-8 px-6 flex justify-between gap-6">
                                {{-- Col 1 --}}
                                <div class="flex-1">
                                    <h4 class="text-[#0c5a9e] font-bold text-[13px] mb-4 leading-snug">Remove Background
                                        From Images</h4>
                                    <ul class="space-y-3">
                                        <li><a href="{{ route('graphics.service-detail', 'clipping-path') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Clipping
                                                Path Service</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'ghost-mannequin') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Ghost
                                                Mannequin Effect</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'image-masking') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Photoshop
                                                Image Masking</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'shadow-service') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Photoshop
                                                Shadow Service</a></li>
                                    </ul>
                                </div>
                                {{-- Col 2 --}}
                                <div class="flex-1">
                                    <h4 class="text-[#0c5a9e] font-bold text-[13px] mb-4 leading-snug">Professional Photo
                                        Retouching</h4>
                                    <ul class="space-y-3">
                                        <li><a href="{{ route('graphics.service-detail', 'photo-restoration') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Photo
                                                Restoration Service</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'color-correction') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Photoshop
                                                Color Correction</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'photo-retouching') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Photography
                                                Retouching</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'high-end-retouching') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">High
                                                End Photo Retouching</a></li>
                                    </ul>
                                </div>
                                {{-- Col 3 --}}
                                <div class="flex-1">
                                    <h4 class="text-[#0c5a9e] font-bold text-[13px] mb-4 leading-snug">Photography Post
                                        Production</h4>
                                    <ul class="space-y-3">
                                        <li><a href="{{ route('graphics.service-detail', 'product-photo-editing') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Product
                                                Photo Editing</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'wedding-photo-editing') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Wedding
                                                Photo Retouching</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'real-estate-editing') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Real
                                                Estate Photo Editing</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'image-blending') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Image
                                                Blending Service</a></li>
                                    </ul>
                                </div>
                                {{-- Col 4 --}}
                                <div class="flex-1">
                                    <h4 class="text-[#0c5a9e] font-bold text-[13px] mb-4 leading-snug">Creative Editing
                                        Services</h4>
                                    <ul class="space-y-3">
                                        <li><a href="{{ route('graphics.service-detail', 'photo-manipulation') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Creative
                                                Photo Manipulation</a></li>
                                        <li><a href="{{ route('graphics.service-detail', '3d-modeling') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">3D
                                                Modeling Services</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'desktop-publishing') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Desktop
                                                Publishing</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'video-editing') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Video
                                                Editing and Post Production Services</a></li>
                                    </ul>
                                </div>
                                {{-- Col 5 --}}
                                <div class="flex-1">
                                    <h4 class="text-[#0c5a9e] font-bold text-[13px] mb-4 leading-snug">Vector Illustration &
                                        Conversion</h4>
                                    <ul class="space-y-3">
                                        <li><a href="{{ route('graphics.service-detail', 'raster-to-vector') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Raster
                                                to Vector Conversion</a></li>
                                        <li><a href="{{ route('graphics.service-detail', 'vector-line-drawing') }}"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Vector
                                                Line Drawing & Artwork</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div x-data="{ videoProdOpen: false }" @mouseenter="videoProdOpen = true"
                        @mouseleave="videoProdOpen = false" class="relative group">
                        <a href="#" class="studio-nav-link transition-colors flex items-center gap-1 cursor-pointer">
                            VIDEO PRODUCTION
                            <i class="ri-arrow-down-s-line text-[14px] transition-transform duration-300"
                                :class="videoProdOpen ? 'rotate-180' : ''"></i>
                            <span class="studio-link-dot"></span>
                        </a>

                        <div x-show="videoProdOpen" x-cloak class="fixed left-0 right-0 pt-6 z-[60]" style="top: auto;"
                            x-transition:enter="transition ease-out duration-200"
                            x-transition:enter-start="opacity-0 translate-y-2"
                            x-transition:enter-end="opacity-100 translate-y-0"
                            x-transition:leave="transition ease-in duration-150"
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <h4 class="text-[#0c5a9e] font-bold text-[13px] mb-4 leading-snug">Video Editing
                                        Services</h4>
                                    <ul class="space-y-3">
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">E-Commerce
                                                Video Editing Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Video
                                                Background Removal Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Video
                                                Object Removal Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Rotoscoping
                                                Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Video
                                                Resizing Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Subtitling
                                                Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Video
                                                Ad Creation Service</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Vlog
                                ...
                                <div class="flex-1">
                                    <h4 class="text-[#0c5a9e] font-bold text-[13px] mb-4 leading-snug">Video Post Production
                                        Services</h4>
                                    <ul class="space-y-3">
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Video
                                                Color Grading Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Film
                                                Editing Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Drone
                                                Video Editing Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Wedding
                                                Video Editing Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Music
                                                Video Editing Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Corporate
                                                Video Editing Services</a></li>
                                    </ul>
                                </div>
                                {{-- Col 3: Audio Editing --}}
                                <div class="flex-1">
                                    ...
                                    <ul class="space-y-3">
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Audio
                                                Enhancement Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Audio
                                                Mixing Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Audio
                                                Noise Reduction Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Dialogue
                                                Editing</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Artificial
                                                Voice Over Editing Service</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Podcast
                                                Audio Editing</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Voice
                                                Over Editing</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <ul class="space-y-3">
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Script
                                                Writing Services</a></li>
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Explanatory
                                                Video</a></li>
                                    </ul>
                                </div>
                                {{-- Col 5: Animation Services --}}
                                <div class="flex-1">
                                    <h4 class="text-[#0c5a9e] font-bold text-[13px] mb-4 leading-snug">Animation Services
                                    </h4>
                                    <ul class="space-y-3">
                                        <li><a href="#"
                                                class="text-[13px] text-[#666] hover:text-[#0c5a9e] transition-colors block">Web
                                                Animation Service</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="py-10 space-y-6 px-8">
                ...
                @else
                    ...
                    <div x-data="{ imageEditSub: false }">
                        ...
                        <div x-show="imageEditSub" class="mt-4 flex flex-col gap-6 pl-4 border-l border-white/10"
                            x-collapse>
                            ...
                            <div>
                                ...
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="{{ route('graphics.service-detail', 'clipping-path') }}" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Clipping
                                        Path Service</a>
                                    <a href="{{ route('graphics.service-detail', 'ghost-mannequin') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Ghost
                                        Mannequin Effect</a>
                                    <a href="{{ route('graphics.service-detail', 'image-masking') }}" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Photoshop
                                        Image Masking</a>
                                    <a href="{{ route('graphics.service-detail', 'shadow-services') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Photoshop
                                        Shadow Service</a>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="{{ route('graphics.service-detail', 'photo-restoration') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Photo
                                        Restoration Service</a>
                                    <a href="{{ route('graphics.service-detail', 'color-correction') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Photoshop
                                        Color Correction</a>
                                    <a href="{{ route('graphics.service-detail', 'photo-retouching') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Photography
                                        Retouching</a>
                                    <a href="{{ route('graphics.service-detail', 'high-end-retouching') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">High
                                        End Photo Retouching</a>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="{{ route('graphics.service-detail', 'product-photo-editing') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Product
                                        Photo Editing</a>
                                    <a href="{{ route('graphics.service-detail', 'wedding-photo-editing') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Wedding
                                        Photo Retouching</a>
                                    <a href="{{ route('graphics.service-detail', 'real-estate-editing') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Real
                                        Estate Photo Editing</a>
                                    <a href="{{ route('graphics.service-detail', 'image-blending') }}" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Image
                                        Blending Service</a>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="{{ route('graphics.service-detail', 'photo-manipulation') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Creative
                                        Photo Manipulation</a>
                                    <a href="{{ route('graphics.service-detail', '3d-modeling') }}" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">3D
                                        Modeling Services</a>
                                    <a href="{{ route('graphics.service-detail', 'desktop-publishing') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Desktop
                                        Publishing</a>
                                    <a href="{{ route('graphics.service-detail', 'video-editing') }}" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Video
                                        Editing and Post Production Services</a>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="{{ route('graphics.service-detail', 'raster-to-vector') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Raster
                                        to Vector Conversion</a>
                                    <a href="{{ route('graphics.service-detail', 'vector-line-drawing') }}"
                                        @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Vector
                                        Line Drawing & Artwork</a>
                                </div>
                            </div>
                    ...
                    <div x-data="{ videoProdSub: false }">
                        ...
                        <div x-show="videoProdSub" class="mt-4 flex flex-col gap-6 pl-4 border-l border-white/10"
                            x-collapse>
                            <div>
                                <h4 class="text-white font-bold text-[14px] mb-2">Video Editing Services</h4>
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">E-Commerce
                                        Video Editing Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Video
                                        Background Removal Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Video
                                        Object Removal Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Rotoscoping
                                        Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Video
                                        Resizing Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Subtitling
                                        Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Video
                                        Ad Creation Service</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Vlog
                                        Editing Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Video
                                        Masking</a>
                            ...
                            <div>
                                ...
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Video
                                        Color Grading Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Film
                                        Editing Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Drone
                                        Video Editing Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Wedding
                                        Video Editing Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Music
                                        Video Editing Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Corporate
                                        Video Editing Services</a>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Audio
                                    ...
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Audio
                                        Noise Reduction Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Dialogue
                                        Editing</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Artificial
                                        Voice Over Editing Service</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Podcast
                                        Audio Editing</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Voice
                                        Over Editing</a>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Script
                                        Writing Services</a>
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Explanatory
                                        Video</a>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex flex-col gap-2 pl-2 border-l border-white/10">
                                    <a href="#" @click="open = false"
                                        class="text-[13px] font-normal text-white/60 hover:text-white transition-colors">Web
                                        Animation Service</a>
                                </div>
                            </div>
                        </div>

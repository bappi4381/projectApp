...
<div class="bg-white min-h-screen text-[#333] font-sans pt-40 lg:pt-56" style="padding-top: 180px;">
    ...
    <div class="container mx-auto px-6 max-w-[850px] mt-10 mb-24 text-center">
        ...
        <div class="max-w-[600px] mx-auto space-y-3 mb-12 text-left" x-data="{ tab: 'primary' }">
            
            {{-- Primary Payment Method Accordion --}}
            <div class="bg-[#efefef] border border-[#111]">
                ...
                <div x-show="tab === 'primary'" class="px-6 pb-6 pt-1" x-collapse>
                    <form action="#" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" value="" placeholder="0.00" class="w-full border border-[#ddd] bg-white px-3 py-[10px] text-[13px] text-[#333] focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-100 placeholder-[#999]">
                        </div>
                        <div>
                            <label class="block text-[10px] font-bold text-[#333] mb-1">Invoice/Job ID:</label>
                            <input type="text" placeholder="Invoice/Job ID" class="w-full border border-[#ddd] bg-white px-3 py-[10px] text-[13px] text-[#333] focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-100 placeholder-[#999]">
                        </div>
                        
                        <div class="pt-2 space-y-2">
                            {{-- PayPal Button --}}
                            <button type="button" class="w-full bg-[#007cd5] hover:bg-[#006bb8] text-white font-bold py-2.5 rounded text-[15px] flex items-center justify-center gap-[4px] shadow-sm transition-colors">
                                Pay with <span class="italic font-black text-[20px] leading-none tracking-tighter ml-1">PayPal</span>
                            </button>
                            {{-- Pay Later Button --}}
                            <button type="button" class="w-full bg-[#007cd5] hover:bg-[#006bb8] text-white font-bold py-2.5 rounded text-[15px] flex items-center justify-center gap-2 shadow-sm transition-colors">
                                <i class="ri-paypal-fill text-[20px] leading-none"></i> Pay Later
                            </button>
                            {{-- Debit/Credit Button --}}
                            <button type="button" class="w-full bg-[#2a2b2c] hover:bg-[#1a1b1c] text-white font-bold py-2.5 rounded text-[15px] flex items-center justify-center gap-2 shadow-sm transition-colors">
                                <i class="ri-bank-card-line text-lg leading-none"></i> Debit or Credit Card
                            </button>
                        </div>

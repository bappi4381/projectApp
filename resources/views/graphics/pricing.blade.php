                    ...
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="relative w-full md:w-[400px] shrink-0 h-[280px] bg-[#f9f9f9] border-r border-[#e5e5e5] overflow-hidden"
                            ...
                            <div class="absolute bottom-3 left-3 z-30 pointer-events-none">
                                <span
                                    class="bg-[#555] text-white text-[10px] font-bold px-3 py-1 rounded-sm shadow-sm inline-block uppercase tracking-wider">BEFORE</span>
                            </div>
                            <div class="absolute bottom-3 right-3 z-30 pointer-events-none">
                                <span
                                    class="bg-[#555] text-white text-[10px] font-bold px-3 py-1 rounded-sm shadow-sm inline-block uppercase tracking-wider">AFTER</span>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3 py-6 flex-grow">
                                @if($service->features && count($service->features) > 0)
                                    @foreach($service->features as $item)
                                        <div
                                            class="flex justify-between items-start text-[12px] border-b border-dotted border-slate-100 pb-1">
                                    ...
                                    @endforeach
                                @else
                                    <p class="text-[11px] text-slate-400 italic col-span-2">Detailed pricing variants coming soon...
                                    </p>
                                @endif
                            </div>

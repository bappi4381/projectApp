<nav
    ...
    : 'text-slate-400 hover:bg-white/[0.03] hover:text-white' }}">
        ...
        @if(request()->routeIs('admin.graphics.*'))
            <div class="space-y-8">
                <div class="space-y-1">
                    <p class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-4 pl-4">Graphics Workspace
                    </p>
            ...
            : 'text-slate-400 hover:bg-white/[0.03] hover:text-white' }}">
                ...
                <div x-data="{ open: @json($isServiceMgmt) }" class="space-y-1">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Service Architecture
                            </p>
                        </div>
                ...
                <div x-data="{ open: @json($isStudio) }" class="space-y-1">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-300"
                        x-transition:enter-start="opacity-0 -translate-y-2"
                        x-transition:enter-end="opacity-100 translate-y-0" class="pt-2 space-y-1">

...
<div class="p-8">
    <div class="flex items-center justify-between mb-10 reveal">
        ...
        <a href="#" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-indigo-500/20 flex items-center gap-2 group">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-white/5">
                    ...
                    <tr class="hover:bg-white/[0.02] transition-all group">
                        ...
                        <td class="px-6 py-5">
                            <span class="text-xs font-bold text-slate-400 bg-slate-800/50 px-3 py-1.5 rounded-lg border border-white/5">{{ ucfirst($service->category) }}</span>
                        </td>
                        <td class="px-6 py-5">
                        ...
                        <td class="px-6 py-5 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <button class="w-9 h-9 rounded-lg bg-white/5 border border-white/5 text-slate-400 hover:text-white hover:bg-white/10 transition-all flex items-center justify-center">
                                    <i class="ri-edit-line text-lg"></i>
                                </button>
                                <button class="w-9 h-9 rounded-lg bg-rose-500/5 border border-rose-500/10 text-rose-500/50 hover:text-rose-400 hover:bg-rose-500/10 transition-all flex items-center justify-center">

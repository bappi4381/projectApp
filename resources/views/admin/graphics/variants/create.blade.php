...
<div class="p-8">
    <div class="mb-10 reveal">
        ...
        <p class="text-slate-400 font-medium text-sm italic">Establish a dedicated landing page for specific service complexities or variants.</p>
    </div>
    ...
    <div x-data="{ 
        ...
        <form action="{{ route('admin.graphics.variants.store') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
            @csrf
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="p-6 bg-emerald-500/5 rounded-3xl border border-emerald-500/10 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-[9px] text-slate-500 uppercase font-black tracking-widest">Always enabled for Detail variants</p>
                        </div>
                        <input type="hidden" name="has_details" value="1">
                        <span class="px-4 py-1.5 rounded-full bg-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase tracking-widest">ENABLED</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div class="space-y-3">
                                ...
                                <input type="number" step="0.01" name="starting_price" x-model="startingPrice" class="w-full bg-indigo-500/10 border border-indigo-500/20 rounded-2xl px-6 py-4 text-sm font-black text-indigo-400 shadow-inner focus:bg-white/5 transition-all">

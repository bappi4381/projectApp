...
@section('title', 'Create Detail Page Variant | Admin')
...
@section('content')
    <div class="p-8">
        <div class="mb-10 reveal">
            ...
            <h1 class="text-3xl font-bold text-white mb-2 tracking-tight">Create Detail Page Variant (L4)</h1>
            <p class="text-slate-400 font-medium text-sm italic">Establish a dedicated landing page for specific service
                complexities or variants.</p>
        </div>
        ...
        <div x-data="{ 
            ...
            updateVariants() {
                ...
                if (service && service.features) {
                    ...
                    this.priceUnit = service.price_unit || 'per image';
                } else {
                    this.variantList = [];
                }
            ...
            <form action="{{ route('admin.graphics.variants.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-10">
                @csrf
                ...
                <div class="glass-card rounded-[32px] border-white/5 shadow-2xl p-10 reveal reveal-delay-1">
                    ...
                    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <input type="hidden" name="icon" value="ri-image-line">
                    </div>
                </div>
                        ...
                        <div class="space-y-8">
                            <div>
                                ...
                                <textarea name="description" rows="5" placeholder="Short description for hero section..."
                                    class="w-full bg-white/5 border border-white/10 rounded-[2rem] px-8 py-6 text-sm font-medium text-slate-300 focus:outline-none focus:border-emerald-500 transition-all resize-none shadow-inner">{{ old('description') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="necessity_text" rows="5"
                                    ...
                                    class="w-full bg-white/5 border border-white/10 rounded-[2rem] px-8 py-6 text-sm font-medium text-slate-300 focus:outline-none focus:border-blue-500 transition-all resize-none shadow-inner">{{ old('necessity_text') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="features_table_heading"
                                    value="{{ old('features_table_heading', 'Differences between Basic and other Clipping Paths') }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div class="space-y-3">
                                    ...
                                    <input type="number" step="0.01" name="starting_price" x-model="startingPrice"
                                        class="w-full bg-indigo-500/10 border border-indigo-500/20 rounded-2xl px-6 py-4 text-sm font-black text-indigo-400 shadow-inner focus:bg-white/5 transition-all">
                                    <p class="text-[9px] text-slate-600 font-bold uppercase px-1">AUTO-FILLED FROM L3</p>
                                </div>
                                <div class="space-y-3">
                                    <label
